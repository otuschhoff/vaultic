...
func metadataDaemonOptions(globalOptions Options, repositoryID string) daemon.Options {
	return daemon.Options{
		...
		S3Endpoint:       globalOptions.MetadataDaemonS3Endpoint,
		S3Region:         globalOptions.MetadataDaemonS3Region,
		S3Provider:       globalOptions.MetadataDaemonS3Provider,
		S3BucketLookup:   globalOptions.MetadataDaemonS3BucketLookup,
