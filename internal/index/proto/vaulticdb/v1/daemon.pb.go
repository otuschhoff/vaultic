...
type TransactionRequest struct {
	...
	PublicationFence       *PublicationFence      `protobuf:"bytes,6,opt,name=publication_fence,json=publicationFence,proto3" json:"publication_fence,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *TransactionRequest) GetPublicationFence() *PublicationFence {
	if x != nil {
...
func (x *PublicationFence) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *PublicationFence) GetDecision() uint64 {
	if x != nil {
		return x.Decision
	}
	return 0
...
func (x *PublicationFence) GetReadSessionId() string {
	if x != nil {
...
func (x *CapabilitiesResponse) GetPublicationFence() bool {
	if x != nil {
		return x.PublicationFence
	}
	return false
...
const file_vaulticdb_v1_daemon_proto_rawDesc = "" +
	...
	"\x13iterator_service_ns\x18\x04 \x01(\x04R\x11iteratorServiceNs\"\xce\x02\n" +
	...
	"\x18require_durability_token\x18\x05 \x01(\bR\x16requireDurabilityToken\x12K\n" +
	"\x11publication_fence\x18\x06 \x01(\v2\x1e.vaulticdb.v1.PublicationFenceR\x10publicationFence\"v\n" +
	"\x10PublicationFence\x12\x1e\n" +
	"\n" +
