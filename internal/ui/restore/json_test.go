...
func TestJSONPrintUpdate(t *testing.T) {
	...
	test.Equals(
		t,
		[]string{
			("{\"message_type\":\"status\",\"seconds_elapsed\":5,\"percent_done\":0.61702127659574" +
				"47,\"total_files\":11,\"files_restored\":3,\"total_bytes\":47,\"bytes_restored\":29}" +
				"\n"),
		},
		term.Output,
	)
...
func TestJSONPrintUpdateWithSkipped(t *testing.T) {
	...
	test.Equals(
		...
		[]string{
			("{\"message_type\":\"status\",\"seconds_elapsed\":5,\"percent_done\":0.61702127659574" +
				"47,\"total_files\":11,\"files_restored\":3,\"files_skipped\":2,\"total_bytes\":47,\"b" +
				"ytes_restored\":29,\"bytes_skipped\":59}\n"),
		},
		term.Output,
	)
}
...
func TestJSONPrintSummaryOnSuccess(t *testing.T) {
	...
	test.Equals(
		t,
		[]string{
			"{\"message_type\":\"summary\",\"seconds_elapsed\":5,\"total_files\":11,\"files_restored\":11,\"total_bytes\":47,\"bytes_restored\":47}\n",
		},
		term.Output,
	)
}
...
func TestJSONPrintSummaryOnErrors(t *testing.T) {
	...
	test.Equals(
		t,
		[]string{
			"{\"message_type\":\"summary\",\"seconds_elapsed\":5,\"total_files\":11,\"files_restored\":3,\"total_bytes\":47,\"bytes_restored\":29}\n",
		},
		term.Output,
	)
}
...
func TestJSONPrintSummaryOnSuccessWithSkipped(t *testing.T) {
	...
	test.Equals(
		t,
		[]string{
			("{\"message_type\":\"summary\",\"seconds_elapsed\":5,\"total_files\":11,\"files_restor" +
				"ed\":11,\"files_skipped\":2,\"total_bytes\":47,\"bytes_restored\":47,\"bytes_skipped" +
				"\":59}\n"),
		},
		term.Output,
	)
...
func TestJSONError(t *testing.T) {
	...
	test.Equals(
		t,
		[]string{
			"{\"message_type\":\"error\",\"error\":{\"message\":\"error \\\"message\\\"\"},\"during\":\"restore\",\"item\":\"/path\"}\n",
		},
		term.Errors,
	)
}
