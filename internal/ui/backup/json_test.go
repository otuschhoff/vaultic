...
func TestJSONError(t *testing.T) {
	...
	test.Equals(
		t,
		[]string{"{\"message_type\":\"error\",\"error\":{\"message\":\"error \\\"message\\\"\"},\"during\":\"archival\",\"item\":\"/path\"}\n"},
		term.Errors,
	)
}
...
func TestJSONScannerError(t *testing.T) {
	...
	test.Equals(
		t,
		[]string{"{\"message_type\":\"error\",\"error\":{\"message\":\"error \\\"message\\\"\"},\"during\":\"scan\",\"item\":\"/path\"}\n"},
		term.Errors,
	)
}
