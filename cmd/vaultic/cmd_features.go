...
To pass feature flags to vaultic, set the VAULTIC_FEATURES environment variable
...
An _alpha_ feature is disabled by default and may change in arbitrary ways between vaultic versions or be removed.
A _beta_ feature is enabled by default, but still can change in minor ways or be removed.
A _stable_ feature is always enabled and cannot be disabled. The flag will be removed in a future vaultic version.
A _deprecated_ feature is always disabled and cannot be enabled. The flag will be removed in a future vaultic version.
