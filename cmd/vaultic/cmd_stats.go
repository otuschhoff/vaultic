...
func statsWalkSnapshot(ctx context.Context, snapshot *data.Snapshot, repo vaultic.Loader, opts StatsOptions, stats *statsContainer, sp *statsui.Progress) error {
	sp.ProcessSnapshot()
...
func statsWalkTree(repo vaultic.Loader, opts StatsOptions, stats *statsContainer, hardLinkIndex *data.HardlinkIndex[struct{}], progress *statsui.Progress) walker.WalkFunc {
