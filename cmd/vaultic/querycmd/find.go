...
func initMultiSnapshotFilter(flags *pflag.FlagSet, filt *data.SnapshotFilter, addHostShorthand bool) {
	...
	flags.StringArrayVarP(
		...
		hostShorthand,
		nil,
		"only consider snapshots for this `host` (can be specified multiple times, use empty string to unset default value) (default: $VAULTIC_HOST)",
	)
	...
	flags.StringArrayVar(
		...
		"path",
		nil,
		"only consider snapshots including this (absolute) `path` (can be specified multiple times, snapshots must include all specified paths)",
	)
...
func initSingleSnapshotFilter(flags *pflag.FlagSet, filt *data.SnapshotFilter) {
	flags.StringArrayVarP(
		...
		"only consider snapshots for this `host`, when snapshot ID \"latest\" is given "+
			"(can be specified multiple times, use empty string to unset default value) (default: $VAULTIC_HOST)",
	)
	...
	flags.StringArrayVar(
		...
		"path",
		nil,
		"only consider snapshots including this (absolute) `path`, when snapshot ID \"latest\" is given "+
