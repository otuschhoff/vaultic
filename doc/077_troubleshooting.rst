...
<https://github.com/otuschhoff/vaultic/issues/new/choose>`_ as this could indicate a bug
...
`forum`_ and `GitHub issues <https://github.com/otuschhoff/vaultic/issues>`_.
...
.. code-block:: console
  ...
  Damaged snapshot files can be caused by backend problems, hardware problems or bugs in vaultic. Please open an issue at https://github.com/otuschhoff/vaultic/issues/new/choose for further troubleshooting!
  Fatal: repository contains errors
