...
_vaultic_backup()
{
    ...
    flags+=("--data-pack-size=")
    two_word_flags+=("--data-pack-size")
    ...
    flags+=("--tree-pack-size=")
    two_word_flags+=("--tree-pack-size")
    flags+=("--use-profile=")
...
_vaultic_forget()
{
    ...
    local_nonpersistent_flags+=("-l")
    flags+=("--keep-minutely=")
    two_word_flags+=("--keep-minutely")
    local_nonpersistent_flags+=("--keep-minutely")
    local_nonpersistent_flags+=("--keep-minutely=")
    flags+=("--keep-hourly=")
    ...
    flags+=("--keep-quarter-yearly=")
    two_word_flags+=("--keep-quarter-yearly")
    local_nonpersistent_flags+=("--keep-quarter-yearly")
    local_nonpersistent_flags+=("--keep-quarter-yearly=")
    flags+=("--keep-half-yearly=")
    two_word_flags+=("--keep-half-yearly")
    local_nonpersistent_flags+=("--keep-half-yearly")
    local_nonpersistent_flags+=("--keep-half-yearly=")
    flags+=("--keep-yearly=")
    ...
    local_nonpersistent_flags+=("--keep-within=")
    flags+=("--keep-within-minutely=")
    two_word_flags+=("--keep-within-minutely")
    local_nonpersistent_flags+=("--keep-within-minutely")
    local_nonpersistent_flags+=("--keep-within-minutely=")
    ...
    local_nonpersistent_flags+=("--keep-within-monthly=")
    flags+=("--keep-within-quarter-yearly=")
    two_word_flags+=("--keep-within-quarter-yearly")
    local_nonpersistent_flags+=("--keep-within-quarter-yearly")
    local_nonpersistent_flags+=("--keep-within-quarter-yearly=")
    flags+=("--keep-within-half-yearly=")
    two_word_flags+=("--keep-within-half-yearly")
    local_nonpersistent_flags+=("--keep-within-half-yearly")
    local_nonpersistent_flags+=("--keep-within-half-yearly=")
    ...
    flags+=("--keep-none")
    local_nonpersistent_flags+=("--keep-none")
...
_vaultic_root_command()
{
    ...
    commands+=("generate")
    if [[ -z "${BASH_VERSION:-}" || "${BASH_VERSINFO[0]:-}" -gt 3 ]]; then
        command_aliases+=("completions")
        aliashash["completions"]="generate"
    fi
    commands+=("help")
    commands+=("init")
    commands+=("key")
