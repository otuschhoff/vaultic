...
Vaultic can interact with an HTTP backend that respects the following REST
API.
...
* ``application/vnd.x.vaultic.rest.v1`` or empty: Select API version 1
* ``application/vnd.x.vaultic.rest.v2``: Select API version 2
