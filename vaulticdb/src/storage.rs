...
pub(crate) struct EngineMetricsSnapshot {
    ...
    pub(crate) multi_get_input_keys: u64,
    pub(crate) multi_get_unique_keys: u64,
    pub(crate) multi_get_sst_visits: u64,
    pub(crate) multi_get_candidate_keys: u64,
    pub(crate) multi_get_needed_blocks: u64,
    pub(crate) multi_get_coalesced_reads: u64,
    pub(crate) multi_get_needed_block_bytes: u64,
    pub(crate) multi_get_coalesced_read_bytes: u64,
    pub(crate) multi_get_projected_reads_gap_8: u64,
    pub(crate) multi_get_projected_read_bytes_gap_8: u64,
    pub(crate) multi_get_projected_reads_gap_32: u64,
    pub(crate) multi_get_projected_read_bytes_gap_32: u64,
    pub(crate) multi_get_projected_reads_gap_128: u64,
    pub(crate) multi_get_projected_read_bytes_gap_128: u64,
...
impl Storage {
    ...
    pub(crate) fn engine_metrics_snapshot(&self) -> EngineMetricsSnapshot {
        ...
        EngineMetricsSnapshot {
            ...
            multi_get_calls: value(slatedb::db_stats::MULTI_GET_CALLS),
            multi_get_input_keys: value(slatedb::db_stats::MULTI_GET_INPUT_KEYS),
            multi_get_unique_keys: value(slatedb::db_stats::MULTI_GET_UNIQUE_KEYS),
            multi_get_sst_visits: value(slatedb::db_stats::MULTI_GET_SST_VISITS),
            multi_get_candidate_keys: value(slatedb::db_stats::MULTI_GET_CANDIDATE_KEYS),
            multi_get_needed_blocks: value(slatedb::db_stats::MULTI_GET_NEEDED_BLOCKS),
            multi_get_coalesced_reads: value(slatedb::db_stats::MULTI_GET_COALESCED_READS),
            multi_get_needed_block_bytes: value(slatedb::db_stats::MULTI_GET_NEEDED_BLOCK_BYTES),
            multi_get_coalesced_read_bytes: value(
                slatedb::db_stats::MULTI_GET_COALESCED_READ_BYTES,
            ),
            multi_get_projected_reads_gap_8: value(
                slatedb::db_stats::MULTI_GET_PROJECTED_READS_GAP_8,
            ),
            multi_get_projected_read_bytes_gap_8: value(
                slatedb::db_stats::MULTI_GET_PROJECTED_READ_BYTES_GAP_8,
            ),
            multi_get_projected_reads_gap_32: value(
                slatedb::db_stats::MULTI_GET_PROJECTED_READS_GAP_32,
            ),
            multi_get_projected_read_bytes_gap_32: value(
                slatedb::db_stats::MULTI_GET_PROJECTED_READ_BYTES_GAP_32,
            ),
            multi_get_projected_reads_gap_128: value(
                slatedb::db_stats::MULTI_GET_PROJECTED_READS_GAP_128,
            ),
            multi_get_projected_read_bytes_gap_128: value(
