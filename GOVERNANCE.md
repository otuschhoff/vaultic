# vaultic project governance

## Overview

The vaultic project uses a governance model commonly described as Benevolent
...
* user: anyone who interacts with the vaultic project
...
* Benevolent Dictator For Life (BDFL): a single individual who makes decisions
  when consensus cannot be reached. vaultic's current BDFL is [@fd0](https://github.com/fd0).
